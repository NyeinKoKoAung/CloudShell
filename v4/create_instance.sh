...
plain='\033[0m'
#region=""
# $1: instance name, $2: machine type, $3: zone, $4: firewall rule name, $5: username, $6: password, $7: message, $8: token, $9: region
